...
1. **Network access level** - controls what external resources can be accessed
2. **Environment variables** - stores API keys, tokens, and credentials
3. **SessionStart hooks** - runs dependency installation and setup scripts
...
1. You **select a GitHub repo and branch**
...
- Network access limited to only production APIs
- Contains production API keys and database URLs
- Runs dependency installation and production database setup

**Development Environment:**
- Full internet access enabled
- Contains development API keys and debug flags
- Runs dependency installation and test data seeding

**Secure Environment:**
- No network access (air-gapped)
- No environment variables stored
- Runs dependency installation from local cache only
